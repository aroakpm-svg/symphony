...
explicit `owner_runtime_module`. After claim-bound EffectLedger readback and before Design 2
classification, the monitor calls that owner's `readback/4` boundary to obtain normalized finding
