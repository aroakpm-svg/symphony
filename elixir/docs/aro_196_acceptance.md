...
| AC-3: repository, checkout, origin, branch, remote head, and Git metadata stay bound | `GitCheckoutPreflight`, `ProjectExecutionContext` | `git_checkout_preflight_test.exs`: exact checkout, wrong origin, branch/head drift, metadata safety/writability, remote attestation, and cleanup cases |
